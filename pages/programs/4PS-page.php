      ...
      <body class="body-list">
        <div class="cont-list">
            <div class="cont-list-mini" style="padding-top: 20px;">
                <div class="scroll">
                  <h1 style="text-align: center; padding: 5px;">4PS</h1>
                <table>
                    <tr>
                      ...
                      <th>Government <br>Program</th>
                                ...
                                <?php
                                    $sql = "SELECT HOUSENUMBER, LASTNAME, FIRSTNAME, MIDDLENAME, SUFFIX, BIRTHDATE, AGE, CONTACTNUMBER, programs.ProgramName, programs.ProgramID
                                    FROM residents
                                    INNER JOIN programs ON programs.ProgramID = residents.ProgramID
                                    WHERE residents.ProgramID = '1';";
